...
def save_dummy(filename):
    with open(filename, 'w') as data_file:
        json.dump({"None": None}, data_file)
...
def run_sequential(args, logger):
    dummy_save_path = os.path.join(args.local_results_path, "models", args.env_args['map_name'],args.unique_token, "dummy")
    ...
    while runner.t_env <= args.t_max:
        filename = os.path.join(dummy_save_path, "dummy.json")
        save_dummy(filename)
